...
pub trait PostgesIdGenerator<Id: IdType>: IdGenerator<Id, Db = Db, Row = DbRow> {
...
impl PostgesIdGenerator<u64> for PostgresAutogeneratedIdGenerator {
...
impl PostgesIdGenerator<uuid::Uuid> for PostgresUuidIdGenerator {
...
pub struct SqlxPgC3p0JsonBuilder<Id: IdType> {
    ...
    pub id_generator: Arc<dyn PostgesIdGenerator<Id>>,
...
impl<Id: IdType> SqlxPgC3p0JsonBuilder<Id> {
    ...
    pub fn with_id_generator<
        NewId: IdType,
        NewGenerator: PostgesIdGenerator<NewId>,
    >(
        self,
...
pub struct SqlxPgC3p0Json<Id: IdType, Data: DataType, CODEC: JsonCodec<Data>> {
    ...
    phantom_id: std::marker::PhantomData<Id>,
    id_generator: Arc<dyn PostgesIdGenerator<Id>>,
    codec: CODEC,
    queries: Queries,
}
