    ...
    SqlxPgC3p0JsonBuilder<Id>
{
    ...
    pub fn build<Data: DataType>(
        self,
    ) -> SqlxPgC3p0Json<Id, Data, DefaultJsonCodec> {
    ...
    > SqlxPgC3p0Json<Id, Data, CODEC>
{
    ...
    pub async fn fetch_one_optional_with_sql<'a, A: 'a + Send + IntoArguments<'a, Db>>(
        ...
        sql.fetch_optional(tx.conn())
            ...
            .map(|row| to_model(&self.codec, self.id_generator.as_ref(), &row, 0, 1, 2, 3, 4))
            .transpose()
    }
    ...
    pub async fn fetch_one_with_sql<'a, A: 'a + Send + IntoArguments<'a, Db>>(
        ...
        sql.fetch_one(tx.conn())
            .await
            .map_err(into_c3p0_error)
            .and_then(|row| to_model(&self.codec, self.id_generator.as_ref(), &row, 0, 1, 2, 3, 4))
    }
...
impl<
        ...
        Data: DataType,
        CODEC: JsonCodec<Data>,
    > C3p0Json<Id, Data, CODEC> for SqlxPgC3p0Json<Id, Data, CODEC>
{
    type Tx = PgTx;
