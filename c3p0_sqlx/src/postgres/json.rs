...
pub trait PostgresIdGenerator<Id: IdType, DbId: PostgresIdType>: Send + Sync {}
...
#[derive(Clone)]
pub struct SqlxPgC3p0JsonBuilder<Id: IdType, DbId: PostgresIdType> {
    pub id_generator: Arc<dyn PostgresIdGenerator<Id, DbId>>,
...
impl SqlxPgC3p0JsonBuilder<u64, i64> {
...
impl<Id: IdType, DbId: PostgresIdType> SqlxPgC3p0JsonBuilder<Id, DbId> {
    ...
    pub fn with_id_generator<NewId: IdType, NewDbId: PostgresIdType, T: 'static + PostgresIdGenerator<NewId, NewDbId> + Send + Sync>(
        self,
        id_generator: T,
    ) -> SqlxPgC3p0JsonBuilder<NewId, NewDbId> {
        SqlxPgC3p0JsonBuilder {
    ...
    pub fn build<Data: DataType>(self) -> SqlxPgC3p0Json<Id, DbId, Data, DefaultJsonCodec> {
    ...
    pub fn build_with_codec<Data: DataType, CODEC: JsonCodec<Data>>(
        self,
        codec: CODEC,
    ) -> SqlxPgC3p0Json<Id, DbId, Data, CODEC> {
        SqlxPgC3p0Json {
...
#[derive(Clone)]
pub struct SqlxPgC3p0Json<Id: IdType, DbId: PostgresIdType, Data: DataType, CODEC: JsonCodec<Data>> {
    phantom_data: std::marker::PhantomData<Data>,
    id_generator: Arc<dyn PostgresIdGenerator<Id, DbId>>,
    codec: CODEC,
    queries: Queries,
}

impl<Id: IdType, DbId: PostgresIdType, Data: DataType, CODEC: JsonCodec<Data>> SqlxPgC3p0Json<Id, DbId, Data, CODEC> {
...
impl<Id: IdType, DbId: PostgresIdType, Data: DataType, CODEC: JsonCodec<Data>> C3p0Json<Id, Data, CODEC>
    for SqlxPgC3p0Json<Id, DbId, Data, CODEC>
{
    type Tx = PgTx;
