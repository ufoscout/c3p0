...
impl<T: IdType + Type<Db>> PostgresIdType for T
where
for<'c> Self: Encode<'c, Db> + Decode<'c, Db> {}

/// A trait that allows the creation of an Id
pub trait PostgresIdGenerator<Id>: Send + Sync {
...
impl PostgresIdGenerator<i64> for PostgresAutogeneratedIdGenerator {
...
#[derive(Clone)]
pub struct SqlxPgC3p0JsonBuilder<Id> {
    pub id_generator: Arc<dyn PostgresIdGenerator<Id>>,
...
impl SqlxPgC3p0JsonBuilder<i64> {
...
impl <Id: PostgresIdType> SqlxPgC3p0JsonBuilder<Id> {
    ...
    pub fn with_id_generator<NewId, T: 'static + PostgresIdGenerator<NewId> + Send + Sync>(
        self,
        id_generator: T,
...
#[derive(Clone)]
pub struct SqlxPgC3p0Json<Id: PostgresIdType, Data: DataType, CODEC: JsonCodec<Data>> {
...
#[async_trait]
impl<Id: PostgresIdType, Data: DataType, CODEC: JsonCodec<Data>> C3p0Json<Id, Data, CODEC> for SqlxPgC3p0Json<Id, Data, CODEC> {
    type Tx = PgTx;
