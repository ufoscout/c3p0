...
use crate::common::{to_model, SqlxVersionType, IdGenerator};
...
pub trait PostgresIdGenerator<Id: IdType, DbId: PostgresIdType>: Clone + Send + Sync + IdGenerator<Id, DbId> {}
...
#[derive(Clone)]
pub struct SqlxPgC3p0JsonBuilder<Id: IdType, DbId: PostgresIdType, Generator: PostgresIdGenerator<Id, DbId>> {
...
impl<Id: IdType, DbId: PostgresIdType, Generator: PostgresIdGenerator<Id, DbId>> SqlxPgC3p0JsonBuilder<Id, DbId, Generator> {
    ...
    pub fn with_id_generator<NewId: IdType, NewDbId: PostgresIdType, NewGenerator: PostgresIdGenerator<NewId, NewDbId>>(
        self,
    ...
    pub fn build<Data: DataType>(self) -> SqlxPgC3p0Json<Id, DbId, Generator, Data, DefaultJsonCodec> {
...
#[derive(Clone)]
pub struct SqlxPgC3p0Json<Id: IdType, DbId: PostgresIdType, Generator: PostgresIdGenerator<Id, DbId>, Data: DataType, CODEC: JsonCodec<Data>> {
...
impl<Id: IdType, DbId: PostgresIdType, Generator: PostgresIdGenerator<Id, DbId>, Data: DataType, CODEC: JsonCodec<Data>> SqlxPgC3p0Json<Id, DbId, Generator, Data, CODEC> {
...
#[async_trait]
impl<Id: IdType, DbId: PostgresIdType, Generator: PostgresIdGenerator<Id, DbId>, Data: DataType, CODEC: JsonCodec<Data>> C3p0Json<Id, Data, CODEC>
    for SqlxPgC3p0Json<Id, DbId, Generator, Data, CODEC>
{
    type Tx = PgTx;
