...
impl MySqlIdGenerator<u64, i64> for MySqlAutogeneratedIdGenerator {
    fn from_inserted_id(&self, inserted_id: u64) -> Result<i64, C3p0Error> {
        Ok(inserted_id as i64)
    }
}

impl IdGenerator<u64, i64> for MySqlAutogeneratedIdGenerator {
...
impl SqlxMySqlC3p0JsonBuilder<u64, i64, MySqlAutogeneratedIdGenerator> {
