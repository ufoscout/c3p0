...
pub trait MySqlIdGenerator<Id: IdType>:
...
impl SqlxMySqlC3p0JsonBuilder<u64, MySqlAutogeneratedIdGenerator> {
...
impl<Id: IdType, Generator: MySqlIdGenerator<Id>>
    SqlxMySqlC3p0JsonBuilder<Id, Generator>
{
    ...
    ) -> SqlxMySqlC3p0JsonBuilder<NewId, NewGenerator> {
        SqlxMySqlC3p0JsonBuilder {
            phantom_id: std::marker::PhantomData,
            id_generator,
    ...
    pub fn build<Data: DataType>(
        self,
    ) -> SqlxMySqlC3p0Json<Id, Generator, Data, DefaultJsonCodec> {
    ...
    pub fn build_with_codec<Data: DataType, CODEC: JsonCodec<Data>>(
        self,
        codec: CODEC,
    ) -> SqlxMySqlC3p0Json<Id, Generator, Data, CODEC> {
        SqlxMySqlC3p0Json {
...
impl<
        ...
        Data: DataType,
        CODEC: JsonCodec<Data>,
    > C3p0Json<Id, Data, CODEC> for SqlxMySqlC3p0Json<Id, Generator, Data, CODEC>
{
    type Tx = MySqlTx;
