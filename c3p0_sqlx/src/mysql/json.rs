...
impl MySqlIdGenerator<i64> for MySqlAutogeneratedIdGenerator {
...
impl <Id: MySqlIdType> SqlxMySqlC3p0JsonBuilder<Id> {
    ...
    pub fn with_id_generator<NewId, T: 'static + MySqlIdGenerator<NewId> + Send + Sync>(
        self,
        id_generator: T,
...
#[derive(Clone)]
pub struct SqlxMySqlC3p0Json<Id: MySqlIdType, Data: DataType, CODEC: JsonCodec<Data>> {
...
impl<Id: MySqlIdType, Data: DataType, CODEC: JsonCodec<Data>> SqlxMySqlC3p0Json<Id, Data, CODEC> {
