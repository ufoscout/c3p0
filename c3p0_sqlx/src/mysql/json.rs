...
pub trait MySqlIdGenerator<Id: IdType, DbId: MySqlIdType>: Send + Sync {}
...
#[derive(Clone)]
pub struct SqlxMySqlC3p0JsonBuilder<Id: IdType, DbId: MySqlIdType> {
    pub id_generator: Arc<dyn MySqlIdGenerator<Id, DbId>>,
...
impl SqlxMySqlC3p0JsonBuilder<u64, u64> {
...
impl<Id: IdType, DbId: MySqlIdType> SqlxMySqlC3p0JsonBuilder<Id, DbId> {
    ...
    pub fn with_id_generator<NewId: IdType, NewDbId: MySqlIdType, T: 'static + MySqlIdGenerator<NewId, NewDbId> + Send + Sync>(
        self,
        id_generator: T,
    ) -> SqlxMySqlC3p0JsonBuilder<NewId, NewDbId> {
        SqlxMySqlC3p0JsonBuilder {
    ...
    pub fn build<Data: DataType>(self) -> SqlxMySqlC3p0Json<Id, DbId, Data, DefaultJsonCodec> {
    ...
    pub fn build_with_codec<Data: DataType, CODEC: JsonCodec<Data>>(
        self,
        codec: CODEC,
    ) -> SqlxMySqlC3p0Json<Id, DbId, Data, CODEC> {
        SqlxMySqlC3p0Json {
...
#[derive(Clone)]
pub struct SqlxMySqlC3p0Json<Id: IdType, DbId: MySqlIdType, Data: DataType, CODEC: JsonCodec<Data>> {
    phantom_data: std::marker::PhantomData<Data>,
    id_generator: Arc<dyn MySqlIdGenerator<Id, DbId>>,
    codec: CODEC,
    queries: Queries,
}

impl<Id: IdType, DbId: MySqlIdType, Data: DataType, CODEC: JsonCodec<Data>> SqlxMySqlC3p0Json<Id, DbId, Data, CODEC> {
...
#[async_trait]
impl<Id: IdType, DbId: MySqlIdType, Data: DataType, CODEC: JsonCodec<Data>> C3p0Json<Id, Data, CODEC>
    for SqlxMySqlC3p0Json<Id, DbId, Data, CODEC>
{
    type Tx = MySqlTx;
