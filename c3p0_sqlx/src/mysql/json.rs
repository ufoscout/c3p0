...
pub trait MySqlIdGenerator<Id: IdType, DbId: MySqlIdType>:
    Clone + Send + Sync + IdGenerator<Id, DbId>
{
    fn inserted_id_to_db_id(&self, inserted_id: u64) -> Result<DbId, C3p0Error>;
...
impl MySqlIdGenerator<u64, i64> for MySqlAutogeneratedIdGenerator {
    fn inserted_id_to_db_id(&self, inserted_id: u64) -> Result<i64, C3p0Error> {
...
impl MySqlIdGenerator<uuid::Uuid, uuid::Uuid> for MySqlUuidIdGenerator {
    fn inserted_id_to_db_id(&self, _inserted_id: u64) -> Result<uuid::Uuid, C3p0Error> {
...
pub struct SqlxMySqlC3p0JsonBuilder<
    Id: IdType,
    DbId: MySqlIdType,
    Generator: MySqlIdGenerator<Id, DbId>,
> {
...
impl<Id: IdType, DbId: MySqlIdType, Generator: MySqlIdGenerator<Id, DbId>>
    SqlxMySqlC3p0JsonBuilder<Id, DbId, Generator>
{
    ...
    pub fn with_id_generator<
        NewId: IdType,
        NewDbId: MySqlIdType,
        NewGenerator: MySqlIdGenerator<NewId, NewDbId>,
    >(
        self,
    ...
    pub fn build<Data: DataType>(
        self,
    ) -> SqlxMySqlC3p0Json<Id, DbId, Generator, Data, DefaultJsonCodec> {
...
impl<
        ...
        Data: DataType,
        CODEC: JsonCodec<Data>,
    > C3p0Json<Id, Data, CODEC> for SqlxMySqlC3p0Json<Id, DbId, Generator, Data, CODEC>
{
    type Tx = MySqlTx;
    ...
    async fn save(
        ...
        let id = if let Some(id) = self.id_generator.generate_id() {
            ...
            let id = sqlx::query(&self.queries.save_sql_query)
                ...
                .map_err(into_c3p0_error)?;
            self.id_generator.inserted_id_to_db_id(id)?
        };
