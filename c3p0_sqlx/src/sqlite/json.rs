...
{
    fn from_inserted_id(&self, inserted_id: i64) -> Result<DbId, C3p0Error>;
}
...
impl SqliteIdGenerator<u64, i64> for SqliteAutogeneratedIdGenerator {
    fn from_inserted_id(&self, inserted_id: i64) -> Result<i64, C3p0Error> {
        Ok(inserted_id)
    }
}
...
impl SqliteIdGenerator<uuid::Uuid, uuid::Uuid> for SqliteUuidIdGenerator {
    fn from_inserted_id(&self, _inserted_id: i64) -> Result<uuid::Uuid, C3p0Error> {
