...
pub trait SqliteIdGenerator<Id: IdType, DbId: SqliteIdType>: Send + Sync {}
...
#[derive(Clone)]
pub struct SqlxSqliteC3p0JsonBuilder<Id: IdType, DbId: SqliteIdType> {
    pub id_generator: Arc<dyn SqliteIdGenerator<Id, DbId>>,
...
impl SqlxSqliteC3p0JsonBuilder<u64, i64> {
...
impl<Id: IdType, DbId: SqliteIdType> SqlxSqliteC3p0JsonBuilder<Id, DbId> {
    ...
    pub fn with_id_generator<NewId: IdType, NewDbId: SqliteIdType, T: 'static + SqliteIdGenerator<NewId, NewDbId> + Send + Sync>(
        self,
        id_generator: T,
    ) -> SqlxSqliteC3p0JsonBuilder<NewId, NewDbId> {
        SqlxSqliteC3p0JsonBuilder {
    ...
    pub fn build<Data: DataType>(self) -> SqlxSqliteC3p0Json<Id, DbId, Data, DefaultJsonCodec> {
    ...
    pub fn build_with_codec<Data: DataType, CODEC: JsonCodec<Data>>(
        self,
        codec: CODEC,
    ) -> SqlxSqliteC3p0Json<Id, DbId, Data, CODEC> {
        SqlxSqliteC3p0Json {
...
#[derive(Clone)]
pub struct SqlxSqliteC3p0Json<Id: IdType, DbId: SqliteIdType, Data: DataType, CODEC: JsonCodec<Data>> {
    phantom_data: std::marker::PhantomData<Data>,
    id_generator: Arc<dyn SqliteIdGenerator<Id, DbId>>,
    codec: CODEC,
    queries: Queries,
}

impl<Id: IdType, DbId: SqliteIdType, Data: DataType, CODEC: JsonCodec<Data>> SqlxSqliteC3p0Json<Id, DbId, Data, CODEC> {
...
#[async_trait]
impl<Id: IdType, DbId: SqliteIdType, Data: DataType, CODEC: JsonCodec<Data>> C3p0Json<Id, Data, CODEC>
    for SqlxSqliteC3p0Json<Id, DbId, Data, CODEC>
{
    type Tx = SqliteTx;
