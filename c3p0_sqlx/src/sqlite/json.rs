...
impl SqliteIdGenerator<i64> for SqliteAutogeneratedIdGenerator {
...
#[derive(Clone)]
pub struct SqlxSqliteC3p0JsonBuilder<Id> {
...
impl SqlxSqliteC3p0JsonBuilder<i64> {
...
impl <Id: SqliteIdType> SqlxSqliteC3p0JsonBuilder<Id> {
    ...
    pub fn with_id_generator<NewId, T: 'static + SqliteIdGenerator<NewId> + Send + Sync>(
        self,
        id_generator: T,
...
#[derive(Clone)]
pub struct SqlxSqliteC3p0Json<Id: SqliteIdType, Data: DataType, CODEC: JsonCodec<Data>> {
...
impl<Id: SqliteIdType, Data: DataType, CODEC: JsonCodec<Data>> SqlxSqliteC3p0Json<Id, Data, CODEC> {
