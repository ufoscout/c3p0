...
pub trait SqliteIdGenerator<Id: IdType, DbId: SqliteIdType>:
    Clone + Send + Sync + IdGenerator<Id, DbId>
{
    fn inserted_id_to_db_id(&self, inserted_id: i64) -> Result<DbId, C3p0Error>;
...
impl SqliteIdGenerator<u64, i64> for SqliteAutogeneratedIdGenerator {
    fn inserted_id_to_db_id(&self, inserted_id: i64) -> Result<i64, C3p0Error> {
        Ok(inserted_id)
    }
...
impl SqliteIdGenerator<uuid::Uuid, uuid::Uuid> for SqliteUuidIdGenerator {
    fn inserted_id_to_db_id(&self, _inserted_id: i64) -> Result<uuid::Uuid, C3p0Error> {
...
impl<Id: IdType, DbId: SqliteIdType, Generator: SqliteIdGenerator<Id, DbId>>
    SqlxSqliteC3p0JsonBuilder<Id, DbId, Generator>
{
    ...
    pub fn with_id_generator<
        NewId: IdType,
        NewDbId: SqliteIdType,
        NewGenerator: SqliteIdGenerator<NewId, NewDbId>,
    >(
        self,
    ...
    pub fn build<Data: DataType>(
        self,
    ) -> SqlxSqliteC3p0Json<Id, DbId, Generator, Data, DefaultJsonCodec> {
...
impl<
        ...
        Data: DataType,
        CODEC: JsonCodec<Data>,
    > C3p0Json<Id, Data, CODEC> for SqlxSqliteC3p0Json<Id, DbId, Generator, Data, CODEC>
{
    type Tx = SqliteTx;
