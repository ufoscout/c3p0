...
pub fn to_model<
    ...
    R: Row<'a, Database = DB>,
    IdIdx: ColumnIndex<'a, R>,
    VersionIdx: ColumnIndex<'a, R>,
    DataIdx: ColumnIndex<'a, R>,
    DB: Database
>(
    codec: &CODEC,
    row: &'a R,
