...
#[tokio_shared::test]
async fn basic_crud() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn should_fetch_stream() -> Result<(), C3p0Error> {
...
#[tokio_shared::test]
async fn should_delete_all() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn should_count() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn should_return_whether_exists_by_id() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn should_update_and_increase_version() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn update_should_return_optimistic_lock_exception() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn should_delete_based_on_id_and_version() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn delete_should_return_optimistic_lock_exception() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub first_name: String,
        pub last_name: String,
...
#[tokio_shared::test]
async fn query_with_tail_should_filter_order_and_limit() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub name: String,
        pub rank: i64,
...
#[tokio_shared::test]
async fn fetch_one_by_id_should_error_with_row_not_found_for_missing_id() -> Result<(), C3p0Error> {
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub name: String,
    }
...
#[tokio_shared::test]
async fn update_should_fail_with_optimistic_lock_after_concurrent_commit() -> Result<(), C3p0Error>
{
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub name: String,
...
#[tokio_shared::test]
async fn drop_table_with_cascade_should_drop_dependent_objects_on_postgres() -> Result<(), C3p0Error>
{
    #[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
    pub struct TestData {
        pub name: String,
    ...
    let view_exists: bool =
        sqlx::query_scalar("SELECT EXISTS (SELECT 1 FROM pg_catalog.pg_views WHERE viewname = $1)")
            .bind(&view)
            .fetch_one(pool.pool())
            .await
            .map_err(C3p0Error::from)?;
