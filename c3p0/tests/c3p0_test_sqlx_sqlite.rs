...
pub type Builder = SqlxSqliteC3p0JsonBuilder<u64, SqliteAutogeneratedIdGenerator>;
pub type UuidBuilder = SqlxSqliteC3p0JsonBuilder<uuid::Uuid, SqliteUuidIdGenerator>;
