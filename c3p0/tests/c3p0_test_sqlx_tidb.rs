...
pub type Builder = SqlxMySqlC3p0JsonBuilder<u64, MySqlAutogeneratedIdGenerator>;
pub type UuidBuilder = SqlxMySqlC3p0JsonBuilder<uuid::Uuid, MySqlUuidIdGenerator>;
