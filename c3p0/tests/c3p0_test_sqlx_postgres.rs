...
pub type Builder = SqlxPgC3p0JsonBuilder<u64, i64, PostgresAutogeneratedIdGenerator>;
pub type UuidBuilder = SqlxPgC3p0JsonBuilder<uuid::Uuid, uuid::Uuid, PostgresUuidIdGenerator>;
